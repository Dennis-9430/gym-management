#!/usr/bin/env python3
"""Script to add JSDoc comments to the POS hooks files."""
import os

def write_usePOS():
    """Write usePOS.ts with full documentation."""
    content = r'''/**
 * =============================================================================
 ...
 *   - Membresías predefinidas del sistema de pagos
 * =============================================================================
 */
...
export interface UsePOSReturn {
  ...
  /** Porcentaje de descuento appliqué */
  subscriptionDiscountPercent: number;
  /** Descuento en USD appliqué */
  ...
  /** Porcentaje de impuesto actual (0-100) */
  taxPercent: number;
  /** Tasa de descuento como decimal (0-1) */
  discountRate: number;
  /** Tasa de impuesto como decimal (0-1) */
  taxRate: number;
  /** Función para establecer tasa de descuento */
  setDiscountRate: (rate: number) => void;
  /** Función para establecer tasa de impuesto */
  setTaxRate: (rate: number) => void;

  // Setters
  /** Establece término de b��squeda */
  setSearch: (search: string) => void;
  /** Establece input de cliente en venta */
  setSaleClientInput: (value: string) => void;
  /** Establece método de pago */
  setPaymentMethod: (value: PaymentMethod) => void;
  /** Establece monto en efectivo */
  setCashAmount: (value: number) => void;
  /** Establece monto de transferencia */
  setTransferAmount: (value: number) => void;
  /** Establece código de voucher */
  setVoucherCode: (value: string) => void;
  /** Abre/cierra modal de venta */
  setSaleModalOpen: (value: boolean) => void;
  /** Abre/cierra modal de suscripción */
  setSubscriptionModalOpen: (value: boolean) => void;
  /** Establece búsqueda de suscripción */
  setSubscriptionSearch: (value: string) => void;
  /** Establece cliente de suscripción */
  setSubscriptio
